...
(function(document, window, $) {
  ...
  // -------------------------------
  (function() {
    $('#exampleConstraintsForm, #exampleConstraintsFormTypes, #signup-form').formValidation({
      framework: "bootstrap4",
      icon: null,
      err: {
        clazz: 'text-help'
      ...
      fields: {
        ...
        id_idf: {
          validators: {
            notEmpty: {
              message: 'The identify is required and cannot be empty'
            }
          }
        },
        password2: {
          validators: {
            notEmpty: {
              message: 'The password 2 is required and cannot be empty'
            }
          }
        },
        password: {
